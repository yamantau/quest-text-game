...
public class Main {
    public static void main(String[] args) {
        ...
        //запустить, если надо что то добавить
        MagicQuestRepository magicQuestRepository = new MagicQuestRepository();

        magicQuestRepository.createNewAnswer(100, "Конец истории", "Вы умерли",
                List.of(
                        new Variant(1, "Начать заново")
                ));

        magicQuestRepository.createNewAnswer(1, "Предыстория", "Сквозь пустоту бесконечности сияющий огонь души просочился в неизвестные просторы. В то далекое время, когда создание и разрушение были лишь неразделимой частью космического танца, происходило зарождение новой вселенной.\n" +
        ...
        magicQuestRepository.createNewAnswer(2, "Взросление", "В мире магии и тайн наш герой, обладая неизведанной силой своей души, стоит перед двумя вариантами выбора, которые определят его судьбу и будущее всей вселенной? \n\n" +
        ...
        magicQuestRepository.createNewAnswer(3, "Путь Света", "Благородный герой принял решение пойти по пути света, стремясь к добру и справедливости. С его доблестью и надеждой на сердце, он начал свое путешествие по миру.\n" +
                        "\n" +
        ...
        magicQuestRepository.createNewAnswer(7, "Защитник, заботящийся о мире", "Герой стал главой ордена рыцарей, объединившего множество благородных душ, стремящихся к свету. Вместе они охраняли мир и сражались с тьмой. Орден рыцарей стал символом надежды и мощи, заставив зло уклоняться перед их присутствием. Герой возглавил ряд успешных кампаний и победил множество противников, обеспечивая мир и благополучие всему миру. Его имя и дела запечатленные в легендах, будут вдохновлять будущих поколений. " +
        ...
        magicQuestRepository.createNewAnswer(9, "Финал", "Герой, решив пойти путем компромисса, начинает использовать запретные силы для борьбы со своими врагами. Начальный успех подталкивает его все глубже во тьму, и он становится все более жестоким и неумолимым.\n" +
                        "\n" +
        ...
        magicQuestRepository.createNewAnswer(8, "Мудрый наставник", "Таким образом, герой, осознавая свою мудрость и знание, продолжил свой путь в роли мудрого наставника. Пока он наставлял молодых магов, мир стал все более и более погружаться во мрак тьмы, а зло начало гнездиться в самых неожиданных местах.\n" +
                        "\n" +
        ...
        magicQuestRepository.createNewAnswer(11, "Финал", "Когда ты выбрал путь остаться наставником, твои ученики смотрят на тебя с восхищением и надеждой. Твои знания и опыт позволяют тебе научить их всему, что ты знаешь о магической вселенной.\n" +
                        "\n" +
        ...
        magicQuestRepository.createNewAnswer(12, "Финал", "Ты снова вступаешь в бой, готовый сразиться со своими врагами. Мощные заклинания пронизывают воздух, а твои противники в ужасе отступают. Ты проявляешь невероятный мастерство и с невероятной силой разрушаешь все преграды на своем пути.\n" +
                        "\n" +
